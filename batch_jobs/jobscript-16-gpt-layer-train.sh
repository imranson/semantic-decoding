...
# python3 decoding/train_EM.py --subject S1 --gpt imagined --gpt-layer 9 #already have model
python3 decoding/train_EM.py --subject S1 --gpt perceived --gpt-layer 10
python3 decoding/train_EM.py --subject S1 --gpt imagined --gpt-layer 10
