...
python3 decoding/run_decoder.py --subject S3 --experiment perceived_multispeaker --task attend-M
python3 decoding/run_decoder.py --subject S3 --experiment perceived_multispeaker --task attend-F

python3 decoding/run_decoder.py --subject S3 --experiment imagined_speech --task alpha_repeat-1
python3 decoding/run_decoder.py --subject S3 --experiment imagined_speech --task alpha_repeat-2
python3 decoding/run_decoder.py --subject S3 --experiment imagined_speech --task bravo_repeat-1
python3 decoding/run_decoder.py --subject S3 --experiment imagined_speech --task bravo_repeat-2
python3 decoding/run_decoder.py --subject S3 --experiment imagined_speech --task charlie_repeat-1
python3 decoding/run_decoder.py --subject S3 --experiment imagined_speech --task charlie_repeat-2
python3 decoding/run_decoder.py --subject S3 --experiment imagined_speech --task delta_repeat-1
python3 decoding/run_decoder.py --subject S3 --experiment imagined_speech --task delta_repeat-2
python3 decoding/run_decoder.py --subject S3 --experiment imagined_speech --task echo_repeat-1
python3 decoding/run_decoder.py --subject S3 --experiment imagined_speech --task echo_repeat-2
