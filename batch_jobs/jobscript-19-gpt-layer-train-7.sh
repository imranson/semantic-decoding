...
python3 decoding/train_EM.py --subject S2 --gpt perceived --gpt-layer 7
python3 decoding/train_EM.py --subject S2 --gpt imagined --gpt-layer 7
python3 decoding/train_EM.py --subject S3 --gpt perceived --gpt-layer 7
python3 decoding/train_EM.py --subject S3 --gpt imagined --gpt-layer 7
